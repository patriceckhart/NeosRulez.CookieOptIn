...
async function fetchCookieMetadataAsync(delayTime = 2000) {
    ...
    if(document.getElementById('cb')) {
        ...
        const cookieBannerButtonDecline = createElement('button', 'cookie_Banner__Button__DECLINE', 'cookie-Banner--Button', [], metadata.buttons.decline.label);
        ...
        function createCookieBanner() {
            ...
            if(metadata.settings.showDeclineButton === '1') {
                cookieBannerRow3.append(cookieBannerButtonDecline);
            }
            ...
            if(document.getElementById('cookie_Banner__Button__DECLINE')) {
                document.getElementById('cookie_Banner__Button__DECLINE').addEventListener('click', (e) => {
                    setCookie('_cs', 'declined', nowPlusOneYear());
                    destroyCookieWindows();
                    createRevokeButton();
                });
            }
